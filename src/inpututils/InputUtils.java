 ...
 */
    public class InputUtils {
        ...
        */
         ...
         * @param minValue them minimum int value allowed
         * @return a valid int entered by user
         */
        public int askUserForInt (String prompt, int maxValue, int minValue){
            Scanner myInput = new Scanner(System.in);
            ...
            do{
                    System.out.println(prompt);
                    System.out.println("You must enter a number between: " + maxValue + " and " + minValue);
